...
Another thing that was done wrong was sending 2 different containers for mobile and desktop views. This increases the size of the data sent to the user, therefore increases loading times.
